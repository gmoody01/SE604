...
# This requestes the .txt file for the dependent variable data and inputs it into the respective columns and will
# construct sheet depending on the number of independent variables. Still working on this section.
# Will properly construct worksheet with one independent variable.
...
if num_of_var == 1: # One variable
    ...
    num_of_loop_var = len(var_ranges[num_of_var - 2])
    col_spacing_index = col2num(starting_col)
    for i in var_ranges[num_of_var - 3]: # First variable
